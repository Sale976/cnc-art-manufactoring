...
# --- MODIFIKOVAN CSS (X dugme pozicionirano uz samu sliku) ---
st.markdown("""
<style>
    ...
    /* OKVIR OKO SLIKE: Drži sliku i X dugme zajedno */
    .lightbox-content {
        position: relative;
    ...
    /* PROMENJENO: Dugme za zatvaranje (X) je sada fiksirano TIK UZ desnu ivicu slike */
    .lightbox-close {
        position: absolute;
        top: -15px;      /* Malo podignuto iznad ivice slike */
        right: -15px;    /* Malo pomereno desno od ivice slike */
        background: #2d190a;  /* Tamno drvo pozadina za X krug */
        color: #e6c280;
        width: 40px;
        height: 40px;
        line-height: 36px;
        text-align: center;
        border-radius: 50%;   /* Pravi savršen krug oko slova X */
        border: 2px solid #cda34f;
        font-size: 28px;
...
if not images:
    ...
    for idx, img_name in enumerate(images):
        ...
        with col:
            ...
            <!-- NOVI Lightbox: Slika i X su spakovani zajedno u klasu lightbox-content -->
