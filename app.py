...
# =========================================================================
# ⚙️ RUČNO PODEŠAVANJE VELIČINE (Ovde menjaš broj i isprobavaš)
# =========================================================================
VISINA_SLIKE = "650px"  # Menjaj ovu vrednost (npr. "500px", "700px", "800px")
...
# =========================================================================
# --- CUSTOM CSS STILIZACIJA (Pozadina, Kartice, Fontovi i Prozor) ---
# =========================================================================
st.markdown("""
<style>
    ...
    /* Stilizacija samog okvira dijaloga da se uklopi u drveni stil */
...
# --- PROMENJENO: Dodat je width="large" koji savršeno centrira i širi prozor ---
@st.dialog("Pregled projekta", width="large")
def otvori_modal(staza, ime):
    img_b64 = get_image_base64(staza)
    # Centriran kontejner koji drži veliku sliku u sredini sajta
    st.markdown(f"""
...
with st.sidebar:
    ...
    ADMIN_PASSWORD = "malisa_mali"  # Tvoja lozinka iz fajla app_2.py[cite: 3]
