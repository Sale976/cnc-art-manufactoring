...
# --- MODIFIKOVAN CSS (Dodat cursor: pointer za prstić i efekat klika) ---
st.markdown("""
<style>
    ...
    /* Kartica je sada klikabilna i menja miš u pokazni prst */
    .card {
        ...
        margin-bottom: 5px;
        cursor: pointer; /* Menja miš u ruku/prstić kad pređeš preko kartice */
    }
    ...
    /* Sakrivamo podrazumevani izgled Streamlit nevidljivog dugmeta preko kartice */
    ...
    .invisible-btn button:hover { background: transparent !important; color: transparent !important; }
    .invisible-btn button:active { background: transparent !important; color: transparent !important; }
...
# =========================================================================
# --- GLAVNI PRIKAZ GALERIJE (Modifikovan za klik na sliku) ---
# =========================================================================
...
if not images:
    ...
    for idx, img_name in enumerate(images):
        ...
        with col:
            # Kreiramo kontejner koji drži i HTML karticu i nevidljivo Streamlit dugme preko nje
            with st.container():
                # HTML izgled same kartice sa slikom
                st.markdown(f"""
                <div class="card">
                ...
                # Nevidljivo dugme koje se prostire tačno preko cele HTML kartice
