...
# --- MODIFIKOVAN CSS (Savršeno preklapanje bez vidljivih dugmića) ---
st.markdown("""
<style>
    ...
    /* Kontejner koji omogućava da se providno dugme pozicionira TAČNO preko kartice */
    .clickable-container {
        position: relative;
        width: 100%;
        margin-bottom: 25px;
    ...
    .clickable-container:hover .card {
    ...
    /* APSOLUTNO POZICIONIRANJE: Dugme se rasteže TAČNO preko cele slike i kartice */
    .invisible-wrapper div[data-testid="stButton"] button {
    ...
    /* Uklanjamo bilo kakve efekte i okvire za to providno dugme */
    .invisible-wrapper div[data-testid="stButton"] button:hover,
    .invisible-wrapper div[data-testid="stButton"] button:active,
    .invisible-wrapper div[data-testid="stButton"] button:focus {
        background: transparent !important;
        color: transparent !important;
        border: none !important;
    ...
    /* CSS za Admin Panel dugmad - da oni ostanu normalni */
...
# =========================================================================
with st.sidebar:
    # Pakujemo admin panel u div klasu kako CSS za providno dugme ne bi pokvario dugmad ovde
...
# =========================================================================
# --- GLAVNI PRIKAZ GALERIJE (Ispravljeno klikanje) ---
# =========================================================================
...
if not images:
    ...
    for idx, img_name in enumerate(images):
        ...
        with col:
            # Otvaramo glavni HTML kontejner sa relativnim pozicioniranjem
            st.markdown('<div class="clickable-container">', unsafe_allow_html=True)
            
            # 1. Renderujemo izgled kartice (Slika i tekst)
            st.markdown(f"""
            <div class="card">
            ...
            # 2. Preko nje stavljamo omotač sa apsolutno pozicioniranim, 100% nevidljivim dugmetom
            st.markdown('<div class="invisible-wrapper">', unsafe_allow_html=True)
            if st.button("", key=f"click_{idx}"):
                otvori_modal(img_path, proj_name)
            st.markdown('</div>', unsafe_allow_html=True)  # Kraj nevidljivog omotača
