...
# --- MODIFIKOVAN CSS (Poluprovidna pozadina za pregled i očišćen kod) ---
st.markdown("""
<style>
    ...
    /* --- PROMENJENO: Poluprovidni Lightbox (Sajt se vidi u pozadini) --- */
    .lightbox {
        display: none;
        position: fixed;
        z-index: 99999;
        ...
        top: 0;
        left: 0;
        /* Promenjeno sa 0.95 na 0.55 za prelepi poluprovidni efekat */
        background: rgba(15, 10, 5, 0.55); 
        backdrop-filter: blur(5px); /* Blago zamućenje da slika i dalje dođe do izražaja */
    }
    ...
    /* Dugme za zatvaranje (X) - Veće i jasnije na prozirnoj pozadini */
    .lightbox-close {
        position: absolute;
        top: 20px;
        right: 40px;
...
if not images:
    ...
    for idx, img_name in enumerate(images):
        ...
        with col:
            # Klik otvara unutrašnji CSS prozor bez ikakvog refresh-a
            st.markdown(f"""
            ...
            <!-- Prozor za veliku sliku sa poluprovidnom pozadinom -->
